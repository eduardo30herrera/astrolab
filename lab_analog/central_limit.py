...
print 
print 'here we approach a normal distribution by using some random samples'
print 
print 'For the original distribution, some random numbers are generated by the random.random_integers function'
print
...
print
c = input('define some N: ') #this sets the number of iterations you want to make)
print
